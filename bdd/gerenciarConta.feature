...
Cenário: Deve ser possível atualizar apenas as próprias informações como usuário do tipo comum 
...
Cenário:  Não deve ser possível atualizar as informações de outro usuário como usuário do tipo comum
    Dado que o usuário do tipo comum esta logado e autenticado na API Raromdb
    E acessou o método PUT /api/user/{id}
...
Cenário:  Deve ser possível atualizar apenas as próprias informações como usuário do tipo crítico
...
Cenário:  Não deve ser possível atualizar as informações de outro usuário como usuário do tipo crítico
    Dado que o usuário do tipo crítico esta logado e autenticado na API Raromdb
    E acessou o método PUT /api/user/{id}
    Quando informar o Id de outro usuário e os novos valores de nome e senha 
    E enviar a requisição
...
Cenário:  Deve ser possível atualizar as próprias informações como usuário do tipo administrador 
...
Cenário:  Deve ser possível atualizar as informações de outro usuário como usuário do tipo administrador 
    Dado que o usuário do tipo administrador esta logado e autenticado na API Raromdb
    E acessou o método PUT /api/user/{id}
    Quando informar o Id de outro usuário e os novos valores de nome e senha 
    E enviar a requisição
