...
Quando preenche todos os campos do formulário com dados válidos
    Preencher formulário cadastro    Carol    caroltestI@raro.com    123456    123456
...
Quando preenche todos os campos do formulário utilizando email de 60 caracteres
    Preencher formulário cadastro    Carol    CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCA@raro.com    123456    123456

Quando preenche todos os campos do formulário utilizando nome de 100 caracteres
    Preencher formulário cadastro    CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC    email@01raro.com    123456    123456
    
Quando preenche todos os campos do formulário utilizando senha de 6 caracteres
    Preencher formulário cadastro    Carol    email@005raro.com    123456    123456

Quando preenche todos os campos do formulário utilizando senha de 12 caracteres
    Preencher formulário cadastro    carol    email@003raro.com    123456789123    123456789123
